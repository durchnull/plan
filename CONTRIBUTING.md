...
[`docs/contributing.md`](docs/contributing.md) is the working reference: self-tests, the eval corpus, and the pre-pull-request checklist. It is kept
current with CI; this file deliberately does not repeat the commands, because a second copy
